...
# 
# Includes build rules for ppmdiff and 40image.c.
#
...
40image: a2test.o uarray2b.o uarray2.o a2plain.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
 

ppmdiff: ppmdiff.o cputiming.o a2plain.o a2blocked.o uarray2.o uarray2b.o 
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
